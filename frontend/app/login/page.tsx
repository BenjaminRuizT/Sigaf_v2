...
function LoginInner() {
  ...
  useEffect(() => {
    if (getStoredToken()) router.replace(params.get("from") || "/dashboard");
  }, []);
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm p-8">
          <h2 className="font-heading text-xl font-semibold text-center mb-6 uppercase tracking-tight">Iniciar Sesión</h2>
...
export default function LoginPage() {
  return <Providers><LoginInner /></Providers>;
}
